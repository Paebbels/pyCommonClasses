...
# ==============================================================================
extlinks = {
	'issue': ('https://github.com/Paebbels/pyCommonClasses/issues/%s', 'issue #'),
	'pull':  ('https://github.com/Paebbels/pyCommonClasses/pull/%s', 'pull request #'),
	'src':   ('https://github.com/Paebbels/pyCommonClasses/blob/master/pyCommonClasses/%s?ts=2', None),
#	'test':  ('https://github.com/Paebbels/pyCommonClasses/blob/master/test/%s?ts=2', None)
}
